...
function goToHeritagepage() {
    window.location.href = "/heritage"; // Navigate to the '/about' route
}

function goToCulturepage() {
    window.location.href = "/culture"; // Navigate to the '/about' route
}
...
function displayRides(bookings) {
    ...
    if (bookings.length === 0) {
        rideInfoDiv.innerHTML = '<h1>No rides found for this location.</h1>';
        return;
    }
